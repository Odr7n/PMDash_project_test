...
from pmdash import models as mdl
...
class ArticleDetailView(ViewCountMixin,DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        images = ShowImage.objects.filter(article = current_object)[0]
